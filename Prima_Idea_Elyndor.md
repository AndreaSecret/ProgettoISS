...
Il gioco è un rip-off di Pokemon, in cui due giocatori si sfidano in una battaglia 1vs1 utilizzando i propri mostri.
La battaglia avviene in locale.
I giocatori possono scegliere i propri mostri prima dell'inizio della battaglia,scegliendo fra un set predefinito in una sorta di modalità 'draft' dove ogni giocatore a turno sceglie un mostro fra quelli disponibili, e diventerà non disponibile per l'altro, dopo di che ognuno sceglie un mostro da potenziare e renderlo più forte. 
Ogni giocatore possiede x mostri (dove x è uguale per entrambi i giocatori) e alternadosi durante i turni potranno scegliere tra alcune mosse disponibili
che ogni mostro 'conosce'. Le mosse aumentano di livello e diventano più potenti dopo un certo lasso di tempo dove poi ogni mostro si può ulteriormente evolvere e utilizzare mosse potenziate (Mosse +)
Ogni mostro ha le sue statistiche, debolezze, e punti di forza.
Le mosse possono essere di potenziamento, indebolimento o danneggiamento dell'avversario.
La battaglia si conclude quando i mostri di un giocatore vengono sconfitti.
